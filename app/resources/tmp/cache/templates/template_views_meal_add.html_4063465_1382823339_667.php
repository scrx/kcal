...
<?php echo $this->form->create(); ?>
	...
	<?php echo $this->form->select('food_id', $foods_array /*array(1 => 'red', 2 => 'green', 3 => 'blue'), array(
    'id' => 'Colors', 'value' => 2) */ ); ?>
 	...
 	<?php echo $this->form->field('date_when',array('placeholder' => 'Data','label'=>false,'class'=>'date','id'=>'date')); ?>
