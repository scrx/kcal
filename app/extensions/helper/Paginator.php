...
class Paginator extends \lithium\template\Helper {
	 ...
	 *
	 * @var string
	 * @see app\extensions\helper\Paginator::_init()
	 */
	 ...
	 *
	 * @var array
	 * @see app\extensions\helper\Paginator::paginate()
	 */
	protected $_strings = array(
		'pagingWrapper'	=> '<div class="pagination pagination-right"><ul>{:content}</ul></div>'
	);
	 ...
	 * _context.
	 *
	 * @see app\extensions\helper\Paginator::__construct()
	...
	public function prev(array $options = array()) {
		...
		if ($this->_page > 1) {
			$config = array('page' => ($this->_page - 1));
	...
	public function numbers(array $options = array()) {
		...
		for ($i = $start; $i <= $end; $i++) {
			$config = $this->_query() + array('page' => $i);
			$url = \lithium\net\http\Router::match(
				$config,
				$this->_context->_config['request'],
				array('absolute' => true)
	 ...
	 *
	 * @see app\extensions\helper\Paginator::prev()
	 * @see app\extensions\helper\Paginator::next()
	 * @see app\extensions\helper\Paginator::numbers()
	 * @see app\extensions\helper\Paginator::__construct()
	 * @see app\extensions\helper\Paginator::$_strings
